...
<<<<<<< HEAD
        //Todo return start time in secound : nav={"playbackOptions":{"startTimeInSeconds":4.28}}
=======

        var qna = QnARetriever.Search(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName + "/WeeklyTechSyncUp.vtt", "is it recording?");

>>>>>>> 92aaabd8a6a0a13d21a912b330418b4b80d0bbc0
    }
}
